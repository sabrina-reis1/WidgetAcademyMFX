            ...
            <div class="card-body" style="position: relative; border-radius: 10px; box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                ...
                <div class='row'>
                    ...
                    <div class='col-md-1'>
									...
									<input type='number' class='form-control' id='idTurma___${indexTurma}' name='idTurma___${indexTurma}' maxlength="4"/>
								</div>
                </div>
...
$(document).ready(function () {
  ...
  $("#parcelas").on("change", (e) => {
    ...
    if(parcelas != "") {
      $("#valorMensal").val((valorCurso / parcelas).toFixed(2));
      var real = ((valorCurso / parcelas).toFixed(2)).toLocaleString('pt-br', {style: 'currency', currency: 'BRL'});
    }
